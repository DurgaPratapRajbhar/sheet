...
router.post('/add', async (req, res) => {
  try {
    const checkSheet = new RelayCheckSheet(req.body);
...
router.post('/edit/:id', async (req, res) => {
  try {
    const checkSheet = await RelayCheckSheet.findByIdAndUpdate(
      req.params.id,
      req.body,
...
router.get('/:id', async (req, res) => {
  try {
    const checkSheet = await RelayCheckSheet.findById(req.params.id);
